...
public class TamborDeHabilidades : MonoBehaviour
{
    ...
    void Start()
    {
        SelecaoDeUpgrade.OnUpgrade += UpgradeHabilidade; //faz a funcao AdicionarHabilidade ser chamada ap�s uma habilidade receber upgrade]s
    ...
    //Funcionamento: botao � apertado: RodarParaEsquerda. Animacao troca de frame: TrocaDeFrameEsquerda. TrocaDeFrameEsquerda chama OnGirandoEsquerda, avisando aos icones para trocar de posicao
